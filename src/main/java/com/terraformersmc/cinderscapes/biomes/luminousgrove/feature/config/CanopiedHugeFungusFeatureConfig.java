package com.terraformersmc.cinderscapes.biomes.luminousgrove.feature.config;
...
public class CanopiedHugeFungusFeatureConfig implements FeatureConfig {
    ...
    public CanopiedHugeFungusFeatureConfig withPlanted(boolean planted) {
        return new CanopiedHugeFungusFeatureConfig(this.soilBlock, this.stemBlock, this.canopyBlock, this.fleshBlock, this.decorationBlock, planted);
    }
}
