...
import com.terraformersmc.cinderscapes.biomes.blackstoneshales.feature.BlackstoneWeepingVinesFeature;
...
public class BlackstoneShalesFeatures {
    public static final Feature<DefaultFeatureConfig> BLACKSTONE_WEEPING_VINES = Cinderscapes.REGISTRATION_HELPER.register(new BlackstoneWeepingVinesFeature(DefaultFeatureConfig.CODEC), "blackstone_weeping_vines");
