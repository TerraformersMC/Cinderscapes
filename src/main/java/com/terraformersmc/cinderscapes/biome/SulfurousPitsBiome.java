...
// TODO: Check
public class SulfurousPitsBiome extends Biome {
    public SulfurousPitsBiome() {
        super(new Settings()
        ...
        this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, CinderscapesFeatures.SULFUROUS_PILE.configure(FeatureConfig.DEFAULT).createDecoratedFeature(CinderscapesDecorators.COUNT_FLOOR.configure(new CountDecoratorConfig(1))));

        this.addSpawn(EntityCategory.MONSTER, new SpawnEntry(EntityType.GHAST, 40, 1, 1));
        this.addSpawn(EntityCategory.MONSTER, new SpawnEntry(EntityType.MAGMA_CUBE, 100, 2, 5));
