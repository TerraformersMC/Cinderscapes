package com.terraformersmc.cinderscapes.villager;
...
public class CinderscapesVillagerTrades {
    ...
    public static void bootstrap(BootstrapContext<VillagerTrade> registerable) {
        ...
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
                Pair.of(MASON_5_EMERALD_ROSE_QUARTZ_PILLAR, CinderscapesItems.ROSE_QUARTZ_PILLAR.asItem()),
                Pair.of(MASON_5_EMERALD_SMOKY_QUARTZ_PILLAR, CinderscapesItems.SMOKY_QUARTZ_PILLAR.asItem()),
                Pair.of(MASON_5_EMERALD_SULFUR_QUARTZ_PILLAR, CinderscapesItems.SULFUR_QUARTZ_PILLAR.asItem()),
                Pair.of(MASON_5_EMERALD_ROSE_QUARTZ_BLOCK, CinderscapesItems.ROSE_QUARTZ_BLOCK.asItem()),
