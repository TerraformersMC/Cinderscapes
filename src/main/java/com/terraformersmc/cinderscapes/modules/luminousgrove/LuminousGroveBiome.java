...
public class LuminousGroveBiome {
    public static final RegistryKey<Biome> INSTANCE = RegistryHelper.register("luminous_grove", create());
    ...
    private static Biome create() {
        return new Biome.Builder()
                ...
                .effects((new BiomeEffects.Builder())
                        ...
                        .music(MusicType.createIngameMusic(LuminousGroveSoundEvents.AMBIENT_MUSIC))
                        .build())
                .build();
    }
    ...
    public static void onInitialize() {
        if (Cinderscapes.CONFIG.enableLuminousGrove) {
            NetherBiomes.addNetherBiome(RegistryKey.of(Registry.BIOME_KEY, Cinderscapes.id("luminous_grove")), NOISE_POINT);
        }
    }
}
