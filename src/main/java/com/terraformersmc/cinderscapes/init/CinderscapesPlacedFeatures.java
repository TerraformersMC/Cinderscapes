...
public class CinderscapesPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        CinderscapesRegistry.register(context, ASHY_SOUL_SAND, CinderscapesConfiguredFeatures.ASHY_SOUL_SAND, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(64)), CountPlacement.of(5), InSquarePlacement.spread(), BiomeFilter.biome());
        CinderscapesRegistry.register(context, ASHY_SOUL_SOIL, CinderscapesConfiguredFeatures.ASHY_SOUL_SOIL, PlacementUtils.FULL_RANGE, CountPlacement.of(10), InSquarePlacement.spread(), BiomeFilter.biome());
        CinderscapesRegistry.register(context, ASHY_GRAVEL, CinderscapesConfiguredFeatures.ASHY_GRAVEL, PlacementUtils.FULL_RANGE, CountPlacement.of(5), InSquarePlacement.spread(), BiomeFilter.biome());
        CinderscapesRegistry.register(context, ASH_TOP_LAYER, CinderscapesConfiguredFeatures.ASH_TOP_LAYER);
        ...
        CinderscapesRegistry.register(context, DEAD_TREES, CinderscapesConfiguredFeatures.DEAD_TREE,
        ...
        CinderscapesRegistry.register(context, SHALES, CinderscapesConfiguredFeatures.SHALE,
        ...
        /* LUMINOUS GROVE */
        CinderscapesRegistry.register(context, SHROOMLIGHT_BUSHES, CinderscapesConfiguredFeatures.SHROOMLIGHT_BUSH, CountOnEveryLayerPlacement.of(2), BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), CinderscapesBlocks.UMBRAL_NYLIUM)), BiomeFilter.biome());
        CinderscapesRegistry.register(context, UMBRAL_VINES, CinderscapesConfiguredFeatures.UMBRAL_VINE, CountOnEveryLayerPlacement.of(5), BiomeFilter.biome());

        CinderscapesRegistry.register(context, LUMINOUS_VEGETATION, CinderscapesConfiguredFeatures.LUMINOUS_VEGETATION, CountOnEveryLayerPlacement.of(8), BiomeFilter.biome());
        CinderscapesRegistry.register(context, LUMINOUS_PODS, CinderscapesConfiguredFeatures.LUMINOUS_POD, CountOnEveryLayerPlacement.of(7), BiomeFilter.biome());
        CinderscapesRegistry.register(context, TALL_PHOTOFERNS, CinderscapesConfiguredFeatures.TALL_PHOTOFERN, CountOnEveryLayerPlacement.of(7), BiomeFilter.biome());

        final List<BlockState> CANOPIED_HUGE_FUNGUS_SAFELIST = List.of(
                CinderscapesBlocks.UMBRAL_NYLIUM.defaultBlockState(),
                Blocks.NETHERRACK.defaultBlockState()
        );
        CinderscapesRegistry.register(context, CANOPIED_HUGE_FUNGUS, CinderscapesConfiguredFeatures.CANOPIED_HUGE_FUNGUS,
        ...
        /* QUARTZ CAVERN */
        CinderscapesRegistry.register(context, QUARTZ_VEGETATION, CinderscapesConfiguredFeatures.QUARTZ_VEGETATION, CountOnEveryLayerPlacement.of(1), BiomeFilter.biome());

        CinderscapesRegistry.register(context, QUARTZ_ORE, CinderscapesConfiguredFeatures.QUARTZ_ORE, CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
        CinderscapesRegistry.register(context, SULFUR_QUARTZ_ORE, CinderscapesConfiguredFeatures.SULFUR_QUARTZ_ORE, CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        CinderscapesRegistry.register(context, ROSE_QUARTZ_ORE, CinderscapesConfiguredFeatures.ROSE_QUARTZ_ORE, CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        CinderscapesRegistry.register(context, SMOKY_QUARTZ_ORE, CinderscapesConfiguredFeatures.SMOKY_QUARTZ_ORE, CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        CinderscapesRegistry.register(context, GOLD_ORE, CinderscapesConfiguredFeatures.GOLD_ORE, CountPlacement.of(20), PlacementUtils.RANGE_10_10, BiomeFilter.biome());
        CinderscapesRegistry.register(context, SULFUR_ORE, CinderscapesConfiguredFeatures.SULFUR_ORE, CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        ...
        CinderscapesRegistry.register(context, CEILING_SHARD_QUARTZ, CinderscapesConfiguredFeatures.CEILING_SHARD_QUARTZ);
        CinderscapesRegistry.register(context, CEILING_SHARD_SULFUR_QUARTZ, CinderscapesConfiguredFeatures.CEILING_SHARD_SULFUR_QUARTZ);
        CinderscapesRegistry.register(context, CEILING_SHARD_ROSE_QUARTZ, CinderscapesConfiguredFeatures.CEILING_SHARD_ROSE_QUARTZ);
        CinderscapesRegistry.register(context, CEILING_SHARD_SMOKY_QUARTZ, CinderscapesConfiguredFeatures.CEILING_SHARD_SMOKY_QUARTZ);
        CinderscapesRegistry.register(context, CEILING_SHARDS, CinderscapesConfiguredFeatures.CEILING_SHARDS, PlacementUtils.countExtra(1, 0.5f, 1), new SafelistRangeCeilingPlacementModifier(VerticalAnchor.aboveBottom(20), VerticalAnchor.belowTop(20), SHARD_SAFELIST), BiomeFilter.biome());

        CinderscapesRegistry.register(context, FLOOR_SHARD_QUARTZ, CinderscapesConfiguredFeatures.FLOOR_SHARD_QUARTZ);
        CinderscapesRegistry.register(context, FLOOR_SHARD_SULFUR_QUARTZ, CinderscapesConfiguredFeatures.FLOOR_SHARD_SULFUR_QUARTZ);
        CinderscapesRegistry.register(context, FLOOR_SHARD_ROSE_QUARTZ, CinderscapesConfiguredFeatures.FLOOR_SHARD_ROSE_QUARTZ);
        CinderscapesRegistry.register(context, FLOOR_SHARD_SMOKY_QUARTZ, CinderscapesConfiguredFeatures.FLOOR_SHARD_SMOKY_QUARTZ);
        CinderscapesRegistry.register(context, FLOOR_SHARDS, CinderscapesConfiguredFeatures.FLOOR_SHARDS, PlacementUtils.countExtra(1, 0.5f, 1), new SafelistRangeFloorPlacementModifier(VerticalAnchor.aboveBottom(20), VerticalAnchor.belowTop(20), SHARD_SAFELIST), BiomeFilter.biome());

        CinderscapesRegistry.register(context, POLYPITE_QUARTZ, CinderscapesConfiguredFeatures.POLYPITE_QUARTZ, CountPlacement.of(128), PlacementUtils.RANGE_10_10, RandomOffsetPlacement.of(UniformInt.of(9, 15), UniformInt.of(4, 7)), BiomeFilter.biome());
        CinderscapesRegistry.register(context, POLYPITE_SULFUR_QUARTZ, CinderscapesConfiguredFeatures.POLYPITE_SULFUR_QUARTZ, CountPlacement.of(128), PlacementUtils.RANGE_10_10, RandomOffsetPlacement.of(UniformInt.of(9, 15), UniformInt.of(4, 7)), BiomeFilter.biome());
        CinderscapesRegistry.register(context, POLYPITE_ROSE_QUARTZ, CinderscapesConfiguredFeatures.POLYPITE_ROSE_QUARTZ, CountPlacement.of(128), PlacementUtils.RANGE_10_10, RandomOffsetPlacement.of(UniformInt.of(9, 15), UniformInt.of(4, 7)), BiomeFilter.biome());
        CinderscapesRegistry.register(context, POLYPITE_SMOKY_QUARTZ, CinderscapesConfiguredFeatures.POLYPITE_SMOKY_QUARTZ, CountPlacement.of(128), PlacementUtils.RANGE_10_10, RandomOffsetPlacement.of(UniformInt.of(9, 15), UniformInt.of(4, 7)), BiomeFilter.biome());
    }
