...
public class CinderscapesRegistry {
	...
	public static <B extends Block> B register(String name, Function<BlockBehaviour.Properties, B> factory, BlockBehaviour.Properties properties) {
		ResourceKey<Block> key = ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Cinderscapes.MOD_ID, name));
	...
	public static <I extends Item> I register(String name, Function<Item.Properties, I> factory, Item.Properties properties) {
		ResourceKey<Item> key = ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Cinderscapes.MOD_ID, name));
	...
	public static <T extends Feature<FC>, FC extends FeatureConfiguration> T register(String name, T feature) {
		return Registry.register(BuiltInRegistries.FEATURE, Identifier.fromNamespaceAndPath(Cinderscapes.MOD_ID, name), feature);
	}
