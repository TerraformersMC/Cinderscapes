...
public class CinderscapesFeatures {
    ...
    public static void init() {
        ...
        ASH_TOP_LAYER = Registry.register(Registries.FEATURE, Cinderscapes.id("ash_top_layer"), new AshTopLayerFeature());
        ...
        CANOPIED_HUGE_FUNGUS = Registry.register(Registries.FEATURE, Cinderscapes.id("canopied_huge_fungus"), new CanopiedHugeFungusFeature());

        SHROOMLIGHT_BUSH = Registry.register(Registries.FEATURE, Cinderscapes.id("shroomlight_bush"), new ShroomlightBushFeature());
        UMBRAL_VINE = Registry.register(Registries.FEATURE, Cinderscapes.id("umbral_vine"), new UmbralVineFeature());

        VEGETATION = Registry.register(Registries.FEATURE, Cinderscapes.id("vegetation"), new VegetationFeature());
        ...
        SHALE_FEATURE = Registry.register(Registries.FEATURE, Cinderscapes.id("shale"), new ShaleFeature());

        BLACKSTONE_WEEPING_VINES = Registry.register(Registries.FEATURE, Cinderscapes.id("blackstone_weeping_vines"), new BlackstoneWeepingVinesFeature());

        CRYSTAL_SHARD_FEATURE = Registry.register(Registries.FEATURE, Cinderscapes.id("crystal_shard"), new CrystalShardFeature());

        POLYPITE_QUARTZ = Registry.register(Registries.FEATURE, Cinderscapes.id("polypite_quartz"), new PolypiteQuartzFeature());

        ASH_PILE = Registry.register(Registries.FEATURE, Cinderscapes.id("ash_pile"), new AshPileFeature());

        DEAD_TREE = Registry.register(Registries.FEATURE, Cinderscapes.id("dead_tree"), new DeadTreeFeature());
