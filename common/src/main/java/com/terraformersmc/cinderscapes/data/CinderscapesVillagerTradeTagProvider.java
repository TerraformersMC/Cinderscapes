...
public class CinderscapesVillagerTradeTagProvider extends FabricTagsProvider<VillagerTrade> {
    protected CinderscapesVillagerTradeTagProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
        super(output, Registries.VILLAGER_TRADE, lookupProvider);
    }

    @Override
    protected void addTags(HolderLookup.Provider registries) {
        this.builder(VillagerTradeTags.MASON_LEVEL_4)
        ...
        this.builder(VillagerTradeTags.MASON_LEVEL_5)
